...
import { Droplets, Phone, Mail, MapPin, Instagram, Clock } from "lucide-react";
    ...
    <footer className="bg-navy-deep text-white">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-display text-lg font-extrabold">PAPPU BHAI TANKER WALE</p>
                <p className="text-xs uppercase tracking-[0.2em] text-white/60">Clean water, delivered fast</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-white/70">
              ...
              <li className="flex items-start gap-2">
                <Instagram className="mt-0.5 h-4 w-4 text-sky" />
                <a href="https://instagram.com/hydroxflow" target="_blank" rel="noreferrer" className="hover:text-white">{COMPANY.instagram}</a>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="mt-10 flex flex-col items-start justify-between gap-3 border-t border-white/10 pt-6 text-xs text-white/50 md:flex-row md:items-center">
          <p>© {new Date().getFullYear()} Pappu Bhai Tanker Wale. All rights reserved.</p>
